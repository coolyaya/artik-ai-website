...
export default function BookDemo() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    (payload as any).service = selected?.name ?? "Unspecified";
    ...
    try {
      ...
      if (url) {
        ...
        console.log("BookDemo payload (set VITE_WEBHOOK_URL to send):", payload);
        alert("Submitted locally (no webhook set).");
        nav("/");
      }
    } catch {
