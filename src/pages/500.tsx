...
export default function ServerErrorPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Something went wrong - ArtikAi</title>
      </Helmet>
      <Navbar variant="dark" />
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 px-4 py-24 text-center sm:py-32">
        ...
        <h1 className="text-3xl font-semibold sm:text-4xl">Something unexpected happened.</h1>
        <p className="max-w-2xl text-base text-slate-300 sm:text-lg">
          Our team has been notified. Try refreshing the page or head back to the home page while we look into it.
        </p>
        <Link
          to="/"
