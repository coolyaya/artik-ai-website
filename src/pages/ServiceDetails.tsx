    ...
    >
      ...
      <section className="relative">
        ...
        <div className="absolute bottom-6 left-6 right-6 max-w-6xl mx-auto">
          ...
          <p className="rise mt-2 text-gray-300 max-w-3xl" style={{ animationDelay: '120ms' }}>{svc.summary}</p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {svc.bullets.map((b, i) => (
              <div key={b} className="rise flex items-start gap-3 p-4 rounded-xl border border-white/10 bg-white/5" style={{ animationDelay: `${160 + i * 80}ms` }}>
          ...
          {/* Chart */}
          <div className="rise rounded-xl border border-white/10 bg-white/5 p-4" style={{ animationDelay: '200ms' }}>
